...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.figureTabWidget.sizePolicy().hasHeightForWidth())
        self.figureTabWidget.setSizePolicy(sizePolicy3)
...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.modeSetupFigButton.sizePolicy().hasHeightForWidth())
        self.modeSetupFigButton.setSizePolicy(sizePolicy5)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 418, 162))
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.xAxesScrollArea.sizePolicy().hasHeightForWidth())
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 188, 181))
...
"}")
        ...
        sizePolicy12.setHeightForWidth(self.finalizeStep0Button.sizePolicy().hasHeightForWidth())
        self.finalizeStep0Button.setSizePolicy(sizePolicy12)
...
"}")
        ...
        sizePolicy13.setHeightForWidth(self.extractPointsWidget.sizePolicy().hasHeightForWidth())
        self.extractPointsWidget.setSizePolicy(sizePolicy13)
        ...
        sizePolicy14.setHeightForWidth(self.calibrationFrame.sizePolicy().hasHeightForWidth())
        self.calibrationFrame.setSizePolicy(sizePolicy14)
...
"}")
        ...
        sizePolicy16.setHorizontalStretch(42)
...
"}")
        ...
        sizePolicy13.setHeightForWidth(self.taggingWidget.sizePolicy().hasHeightForWidth())
        self.taggingWidget.setSizePolicy(sizePolicy13)
...
"}")
        ...
        sizePolicy10.setHeightForWidth(self.clearAllButton.sizePolicy().hasHeightForWidth())
        self.clearAllButton.setSizePolicy(sizePolicy10)
...
" font-size:16px;")
        ...
        sizePolicy17.setHeightForWidth(self.datasetListView.sizePolicy().hasHeightForWidth())
        self.datasetListView.setSizePolicy(sizePolicy17)
...
"}")
        ...
        sizePolicy3.setHeightForWidth(self.finalStateLineEdit.sizePolicy().hasHeightForWidth())
        self.finalStateLineEdit.setSizePolicy(sizePolicy3)
...
"}")
        ...
        sizePolicy13.setHeightForWidth(self.prefitWidget.sizePolicy().hasHeightForWidth())
        self.prefitWidget.setSizePolicy(sizePolicy13)
...
" font-size: 16px;")
        ...
        sizePolicy14.setHeightForWidth(self.frame_prefit_minmax.sizePolicy().hasHeightForWidth())
        self.frame_prefit_minmax.setSizePolicy(sizePolicy14)
        ...
        sizePolicy20 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        sizePolicy20.setHorizontalStretch(0)
        sizePolicy20.setVerticalStretch(0)
        sizePolicy20.setHeightForWidth(self.scrollArea.sizePolicy().hasHeightForWidth())
        self.scrollArea.setSizePolicy(sizePolicy20)
...
"}")
        ...
        sizePolicy13.setHeightForWidth(self.fitWidget.sizePolicy().hasHeightForWidth())
        self.fitWidget.setSizePolicy(sizePolicy13)
...
"}")
        ...
        sizePolicy21 = QSizePolicy(QSizePolicy.MinimumExpanding, QSizePolicy.MinimumExpanding)
        sizePolicy21.setHorizontalStretch(100)
        sizePolicy21.setVerticalStretch(100)
        sizePolicy21.setHeightForWidth(self.mplFigureCanvasContainerWidget.sizePolicy().hasHeightForWidth())
        self.mplFigureCanvasContainerWidget.setSizePolicy(sizePolicy21)
        self.mplFigureCanvasContainerWidget.setMinimumSize(QSize(700, 500))
        ...
        self.mplFigureCanvas.setGeometry(QRect(10, 10, 700, 601))
        sizePolicy21.setHeightForWidth(self.mplFigureCanvas.sizePolicy().hasHeightForWidth())
        self.mplFigureCanvas.setSizePolicy(sizePolicy21)
        self.mplFigureCanvas.setMinimumSize(QSize(700, 500))
...
"")
        ...
        self.toolBar = QWidget(self.mplFigureCanvasContainerWidget)
        self.toolBar.setObjectName(u"toolBar")
        self.toolBar.setGeometry(QRect(10, 10, 700, 80))
        sizePolicy21.setHeightForWidth(self.toolBar.sizePolicy().hasHeightForWidth())
        self.toolBar.setSizePolicy(sizePolicy21)
        self.toolBar.setMinimumSize(QSize(700, 80))
        self.toolBar.setAutoFillBackground(False)
        self.toolBar.setStyleSheet(u"QWidget {\n"
"	background-color: #2A2A2A;\n"
"}\n"
"")
        self.label_37 = QLabel(self.toolBar)
        ...
        self.label_36 = QLabel(self.toolBar)
        ...
        self.label_51 = QLabel(self.toolBar)
        ...
        self.label_27 = QLabel(self.toolBar)
        ...
        self.label_34 = QLabel(self.toolBar)
        ...
        self.calibratedCheckBox = QPushButton(self.toolBar)
...
"")
        icon15 = QIcon()
        icon15.addFile(u":/icons/svg/toggle-off.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon15.addFile(u":/icons/svg/toggle-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.calibratedCheckBox.setIcon(icon15)
        self.calibratedCheckBox.setIconSize(QSize(60, 50))
        self.calibratedCheckBox.setCheckable(True)
        self.label_9 = QLabel(self.toolBar)
        ...
        self.label_35 = QLabel(self.toolBar)
        ...
        self.mplFigureButtons = MplNavButtons(self.toolBar)
        self.mplFigureButtons.setObjectName(u"mplFigureButtons")
        self.mplFigureButtons.setGeometry(QRect(0, 0, 16777215, 90))
        sizePolicy4.setHeightForWidth(self.mplFigureButtons.sizePolicy().hasHeightForWidth())
        self.mplFigureButtons.setSizePolicy(sizePolicy4)
...
"")
...
#endif // QT_CONFIG(tooltip)
        icon16 = QIcon()
        icon16.addFile(u":/icons/svg/reset.svg", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
        icon17 = QIcon()
        icon17.addFile(u":/icons/svg/move.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon17.addFile(u":/icons/svg/move-on.svg", QSize(), QIcon.Normal, QIcon.On)
...
#endif // QT_CONFIG(tooltip)
        icon18 = QIcon()
        icon18.addFile(u":/icons/svg/zoom.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon18.addFile(u":/icons/svg/zoom-on.svg", QSize(), QIcon.Normal, QIcon.On)
...
#endif // QT_CONFIG(tooltip)
        icon19 = QIcon()
        icon19.addFile(u":/icons/svg/x-snap.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon19.addFile(u":/icons/svg/x-snap-on.svg", QSize(), QIcon.Normal, QIcon.On)
...
#endif // QT_CONFIG(tooltip)
        icon20 = QIcon()
        icon20.addFile(u":/icons/svg/extract.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon20.addFile(u":/icons/svg/extract-on.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        self.panViewButton.raise_()
        self.zoomViewButton.raise_()
        self.verticalSnapButton.raise_()
        self.horizontalSnapButton.raise_()
        self.resetViewButton.raise_()
        self.selectViewButton.raise_()
        self.label_50 = QLabel(self.toolBar)
        ...
        self.mplFigureButtons.raise_()
        self.label_34.raise_()
        self.label_37.raise_()
        self.label_35.raise_()
        self.label_50.raise_()
        self.label_27.raise_()
        self.calibratedCheckBox.raise_()
        self.label_9.raise_()
