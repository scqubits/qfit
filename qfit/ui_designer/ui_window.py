...
"}")
        ...
        sizePolicy5.setHeightForWidth(self.allDatasetsFrame.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icons/16x16/cil-plus.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/16x16/cil-minus.png", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
        icon6 = QIcon()
        icon6.addFile(u":/icons/16x16/cil-reload.png", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
        icon7 = QIcon()
        icon7.addFile(u":/icons/16x16/cil-move.png", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
        icon8 = QIcon()
        icon8.addFile(u":/icons/16x16/cil-zoom-in.png", QSize(), QIcon.Normal, QIcon.Off)
...
#endif // QT_CONFIG(tooltip)
        icon9 = QIcon()
        icon9.addFile(u":/icons/16x16/cil-location-pin.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/24x24/cil-list.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/24x24/cil-speedometer.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/icons/24x24/cil-location-pin.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/icons/24x24/cil-chart-line.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        sizePolicy1.setHeightForWidth(self.pagesStackedWidget.sizePolicy().hasHeightForWidth())
...
"")
        ...
        icon14 = QIcon()
        icon14.addFile(u":/icons/16x16/cil-caret-right.png", QSize(), QIcon.Normal, QIcon.Off)
        icon14.addFile(u":/icons/16x16/cil-caret-bottom.png", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy10.setHeightForWidth(self.colorComboBox.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy11.setHeightForWidth(self.xyzDataGridFrame.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy11.setHeightForWidth(self.calibrateXGridFrame.sizePolicy().hasHeightForWidth())
...
#endif // QT_CONFIG(tooltip)
        icon21 = QIcon()
        icon21.addFile(u":/icons/16x16/cil-at.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        sizePolicy11.setHeightForWidth(self.calibrateYGridFrame.sizePolicy().hasHeightForWidth())
