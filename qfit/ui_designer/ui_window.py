...
"}")
        ...
        self.gridLayout_4.addItem(self.verticalSpacer_9, 0, 0, 1, 1)
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.colorComboBox.sizePolicy().hasHeightForWidth())
        self.colorComboBox.setSizePolicy(sizePolicy4)
...
" font-size:16px;")
        ...
        sizePolicy6.setHeightForWidth(self.bgndSubtractXCheckBox.sizePolicy().hasHeightForWidth())
        self.bgndSubtractXCheckBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.bgndSubtractYCheckBox.sizePolicy().hasHeightForWidth())
        self.bgndSubtractYCheckBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.pointsAddLineEdit.sizePolicy().hasHeightForWidth())
        self.pointsAddLineEdit.setSizePolicy(sizePolicy6)
...
"}")
        icon7 = QIcon()
        icon7.addFile(u":/icons/svg/question-circle.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.prefitResultHelpPushButton.setIcon(icon7)
        ...
        sizePolicy4.setHeightForWidth(self.numericalSpectrumSettingsLabel.sizePolicy().hasHeightForWidth())
        self.numericalSpectrumSettingsLabel.setSizePolicy(sizePolicy4)
        font4 = QFont()
...
"    background: none;\n"
"}")
        self.numericalSpectrumSettingsHelpPushButton.setIcon(icon7)
        ...
        sizePolicy6.setHeightForWidth(self.subsysComboBox.sizePolicy().hasHeightForWidth())
        self.subsysComboBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.initStateLineEdit.sizePolicy().hasHeightForWidth())
        self.initStateLineEdit.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.evalsCountLineEdit.sizePolicy().hasHeightForWidth())
        self.evalsCountLineEdit.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.prefitPhotonSpinBox.sizePolicy().hasHeightForWidth())
        self.prefitPhotonSpinBox.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.tolLineEdit.sizePolicy().hasHeightForWidth())
        self.tolLineEdit.setSizePolicy(sizePolicy6)
...
" font-size: 16px;")
        ...
        sizePolicy6.setHeightForWidth(self.optimizerComboBox.sizePolicy().hasHeightForWidth())
        self.optimizerComboBox.setSizePolicy(sizePolicy6)
...
"    background: none;\n"
"}")
        self.fitResultHelpPushButton.setIcon(icon7)
        ...
        sizePolicy6.setHeightForWidth(self.pagesStackedWidget.sizePolicy().hasHeightForWidth())
...
"    background: none;\n"
"}")
        self.calibrationHelpPushButton.setIcon(icon7)
        ...
        sizePolicy6.setHeightForWidth(self.zComboBox.sizePolicy().hasHeightForWidth())
        self.zComboBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy12.setHorizontalStretch(42)
        ...
        sizePolicy6.setHeightForWidth(self.xComboBox.sizePolicy().hasHeightForWidth())
        self.xComboBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.calibrateXGridFrame.sizePolicy().hasHeightForWidth())
        self.calibrateXGridFrame.setSizePolicy(sizePolicy6)
        self.calibrateXGridFrame.setMinimumSize(QSize(386, 100))
        self.calibrateXGridFrame.setMaximumSize(QSize(386, 16777215))
...
"}")
        ...
        self.gridLayout_10.addWidget(self.label_18, 2, 7, 1, 1)

        self.horizontalSpacer_43 = QSpacerItem(12, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_43, 1, 2, 1, 1)

        self.horizontalSpacer_19 = QSpacerItem(10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_19, 1, 8, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_11, 0, 9, 1, 1)

        self.horizontalSpacer_20 = QSpacerItem(10, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_20, 1, 4, 1, 1)

        self.mapX1LineEdit = CalibrationLineEdit(self.calibrateXGridFrame)
        self.mapX1LineEdit.setObjectName(u"mapX1LineEdit")
        sizePolicy6.setHeightForWidth(self.mapX1LineEdit.sizePolicy().hasHeightForWidth())
        self.mapX1LineEdit.setSizePolicy(sizePolicy6)
        self.mapX1LineEdit.setMinimumSize(QSize(130, 30))
        self.mapX1LineEdit.setMaximumSize(QSize(130, 30))
#if QT_CONFIG(tooltip)
        ...
        self.gridLayout_10.addWidget(self.mapX1LineEdit, 1, 9, 1, 1)

        self.horizontalSpacer_42 = QSpacerItem(40, 20, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_42, 2, 10, 1, 1)

        self.mapX2LineEdit = CalibrationLineEdit(self.calibrateXGridFrame)
        self.mapX2LineEdit.setObjectName(u"mapX2LineEdit")
        sizePolicy6.setHeightForWidth(self.mapX2LineEdit.sizePolicy().hasHeightForWidth())
        self.mapX2LineEdit.setSizePolicy(sizePolicy6)
        self.mapX2LineEdit.setMinimumSize(QSize(130, 30))
        self.mapX2LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        self.gridLayout_10.addWidget(self.mapX2LineEdit, 2, 9, 1, 1)
        ...
        sizePolicy6.setHeightForWidth(self.calibrateX1Button.sizePolicy().hasHeightForWidth())
        self.calibrateX1Button.setSizePolicy(sizePolicy6)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/svg/target.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.calibrateX1Button.setIcon(icon8)
        ...
        self.gridLayout_10.addItem(self.horizontalSpacer_17, 1, 10, 1, 1)

        self.rawX1LineEdit = CalibrationLineEdit(self.calibrateXGridFrame)
        self.rawX1LineEdit.setObjectName(u"rawX1LineEdit")
        sizePolicy6.setHeightForWidth(self.rawX1LineEdit.sizePolicy().hasHeightForWidth())
        self.rawX1LineEdit.setSizePolicy(sizePolicy6)
        self.rawX1LineEdit.setMinimumSize(QSize(130, 30))
        self.rawX1LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        self.gridLayout_10.addWidget(self.rawX1LineEdit, 1, 5, 1, 1)

        self.rawX2LineEdit = CalibrationLineEdit(self.calibrateXGridFrame)
        self.rawX2LineEdit.setObjectName(u"rawX2LineEdit")
        sizePolicy6.setHeightForWidth(self.rawX2LineEdit.sizePolicy().hasHeightForWidth())
        self.rawX2LineEdit.setSizePolicy(sizePolicy6)
        self.rawX2LineEdit.setMinimumSize(QSize(130, 30))
        self.rawX2LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        self.gridLayout_10.addWidget(self.rawX2LineEdit, 2, 5, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.label_17, 1, 7, 1, 1)

        self.calibrateX2Button = QPushButton(self.calibrateXGridFrame)
        self.calibrateX2Button.setObjectName(u"calibrateX2Button")
        sizePolicy6.setHeightForWidth(self.calibrateX2Button.sizePolicy().hasHeightForWidth())
        self.calibrateX2Button.setSizePolicy(sizePolicy6)
        ...
        self.calibrateX2Button.setIcon(icon8)
        ...
        self.horizontalSpacer_44 = QSpacerItem(12, 20, QSizePolicy.Fixed, QSizePolicy.Minimum)

        self.gridLayout_10.addItem(self.horizontalSpacer_44, 1, 6, 1, 1)
        ...
        sizePolicy6.setHeightForWidth(self.yComboBox.sizePolicy().hasHeightForWidth())
        self.yComboBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.calibrateYGridFrame.sizePolicy().hasHeightForWidth())
        self.calibrateYGridFrame.setSizePolicy(sizePolicy6)
        self.calibrateYGridFrame.setMinimumSize(QSize(386, 100))
        self.calibrateYGridFrame.setMaximumSize(QSize(386, 16777215))
#if QT_CONFIG(tooltip)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.calibrateY2Button.sizePolicy().hasHeightForWidth())
        self.calibrateY2Button.setSizePolicy(sizePolicy6)
        ...
        self.calibrateY2Button.setIcon(icon8)
        ...
        sizePolicy6.setHeightForWidth(self.rawY1LineEdit.sizePolicy().hasHeightForWidth())
        self.rawY1LineEdit.setSizePolicy(sizePolicy6)
        self.rawY1LineEdit.setMinimumSize(QSize(130, 30))
        self.rawY1LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        sizePolicy6.setHeightForWidth(self.mapY1LineEdit.sizePolicy().hasHeightForWidth())
        self.mapY1LineEdit.setSizePolicy(sizePolicy6)
        self.mapY1LineEdit.setMinimumSize(QSize(130, 30))
        self.mapY1LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        sizePolicy6.setHeightForWidth(self.rawY2LineEdit.sizePolicy().hasHeightForWidth())
        self.rawY2LineEdit.setSizePolicy(sizePolicy6)
        self.rawY2LineEdit.setMinimumSize(QSize(130, 30))
        self.rawY2LineEdit.setMaximumSize(QSize(130, 16777215))
        ...
        sizePolicy6.setHeightForWidth(self.mapY2LineEdit.sizePolicy().hasHeightForWidth())
        self.mapY2LineEdit.setSizePolicy(sizePolicy6)
        self.mapY2LineEdit.setMinimumSize(QSize(130, 30))
        self.mapY2LineEdit.setMaximumSize(QSize(130, 16777215))
#if QT_CONFIG(tooltip)
        ...
        sizePolicy6.setHeightForWidth(self.calibrateY1Button.sizePolicy().hasHeightForWidth())
        self.calibrateY1Button.setSizePolicy(sizePolicy6)
        ...
        self.calibrateY1Button.setIcon(icon8)
        ...
        sizePolicy6.setHeightForWidth(self.swapXYButton.sizePolicy().hasHeightForWidth())
        self.swapXYButton.setSizePolicy(sizePolicy6)
...
"}")
        icon9 = QIcon()
        icon9.addFile(u":/icons/svg/updown.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.swapXYButton.setIcon(icon9)
        ...
        sizePolicy6.setHeightForWidth(self.newRowButton.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/svg/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.newRowButton.setIcon(icon10)
...
"}")
        ...
        icon11 = QIcon()
        icon11.addFile(u":/icons/svg/trash.svg", QSize(), QIcon.Normal, QIcon.Off)
...
" font-size:16px;")
        ...
        self.datasetListView.setFont(font6)
...
"")
        ...
        sizePolicy4.setHeightForWidth(self.tagDressedGroupBox.sizePolicy().hasHeightForWidth())
        self.tagDressedGroupBox.setSizePolicy(sizePolicy4)
        font7 = QFont()
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.initialStateSpinBox.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.phNumberDressedSpinBox.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy6.setHeightForWidth(self.finalStateSpinBox.sizePolicy().hasHeightForWidth())
        ...
        self.tagDispersiveDressedRadioButton.setFont(font8)
#if QT_CONFIG(tooltip)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.deleteRowButton.sizePolicy().hasHeightForWidth())
...
"}")
        ...
        self.deleteRowButton.setIcon(icon11)
...
" font-size: 16px;")
        ...
        self.prefitScrollAreaWidget.setGeometry(QRect(0, 0, 441, 570))
        ...
        sizePolicy4.setHeightForWidth(self.frame_prefit_minmax.sizePolicy().hasHeightForWidth())
        self.frame_prefit_minmax.setSizePolicy(sizePolicy4)
...
"border-bottom-right-radius: 6px;	")
        ...
        self.prefitMinmaxScrollAreaWidget.setGeometry(QRect(0, 0, 446, 60))
        ...
        sizePolicy6.setHeightForWidth(self.autoRunCheckBox.sizePolicy().hasHeightForWidth())
        self.autoRunCheckBox.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.plotButton.sizePolicy().hasHeightForWidth())
        self.plotButton.setSizePolicy(sizePolicy6)
...
"}")
        icon12 = QIcon()
        icon12.addFile(u":/icons/svg/play.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.plotButton.setIcon(icon12)
        ...
        sizePolicy6.setHeightForWidth(self.exportToFitButton.sizePolicy().hasHeightForWidth())
        self.exportToFitButton.setSizePolicy(sizePolicy6)
...
"}")
        icon13 = QIcon()
        icon13.addFile(u":/icons/svg/copy.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        sizePolicy4.setHeightForWidth(self.fitLabel.sizePolicy().hasHeightForWidth())
        self.fitLabel.setSizePolicy(sizePolicy4)
        self.fitLabel.setMinimumSize(QSize(0, 23))
        self.fitLabel.setMaximumSize(QSize(16777215, 16777215))
        self.fitLabel.setFont(font2)
...
"    background: none;\n"
"}")
        self.fitHelpPushButton.setIcon(icon7)
...
"}")
        ...
        self.fitScrollAreaWidget.setGeometry(QRect(0, 0, 441, 507))
        ...
        sizePolicy6.setHeightForWidth(self.fitButton.sizePolicy().hasHeightForWidth())
        self.fitButton.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.exportToPrefitButton.sizePolicy().hasHeightForWidth())
        self.exportToPrefitButton.setSizePolicy(sizePolicy6)
...
"}")
        ...
        sizePolicy17 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Expanding)
        sizePolicy17.setHorizontalStretch(0)
        sizePolicy17.setVerticalStretch(0)
        sizePolicy17.setHeightForWidth(self.menu_frame.sizePolicy().hasHeightForWidth())
        self.menu_frame.setSizePolicy(sizePolicy17)
...
"}")
        ...
        self.modeFitButton.setFont(font2)
        self.modeFitButton.setStyleSheet(u"font-size: 16px;")
        icon14 = QIcon()
        icon14.addFile(u":/icons/svg/cil-speedometer.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.modeFitButton.setIcon(icon14)
        ...
        self.modeTagButton.setFont(font2)
        self.modeTagButton.setStyleSheet(u"font-size: 16px;")
        icon15 = QIcon()
        icon15.addFile(u":/icons/svg/cil-location-pin.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.modeTagButton.setIcon(icon15)
        ...
        self.modeSelectButton.setFont(font2)
        self.modeSelectButton.setStyleSheet(u"font-size: 16px;")
        icon16 = QIcon()
        icon16.addFile(u":/icons/svg/cil-list.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.modeSelectButton.setIcon(icon16)
...
"}")
        icon17 = QIcon()
        icon17.addFile(u":/icons/svg/cil-menu.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.toggleMenuButton.setIcon(icon17)
        ...
        self.modePrefitButton.setFont(font2)
        self.modePrefitButton.setStyleSheet(u"font-size: 16px;")
        icon18 = QIcon()
        icon18.addFile(u":/icons/svg/cil-chart-line.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.modePrefitButton.setIcon(icon18)
...
"")
        ...
        sizePolicy6.setHeightForWidth(self.mplFigureButtons.sizePolicy().hasHeightForWidth())
        self.mplFigureButtons.setSizePolicy(sizePolicy6)
...
"")
...
#endif // QT_CONFIG(tooltip)
        icon19 = QIcon()
        icon19.addFile(u":/icons/svg/reset.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.resetViewButton.setIcon(icon19)
...
#endif // QT_CONFIG(tooltip)
        icon20 = QIcon()
        icon20.addFile(u":/icons/svg/move.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon20.addFile(u":/icons/svg/move-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.panViewButton.setIcon(icon20)
...
#endif // QT_CONFIG(tooltip)
        icon21 = QIcon()
        icon21.addFile(u":/icons/svg/zoom.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon21.addFile(u":/icons/svg/zoom-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.zoomViewButton.setIcon(icon21)
...
#endif // QT_CONFIG(tooltip)
        icon22 = QIcon()
        icon22.addFile(u":/icons/svg/x-snap.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon22.addFile(u":/icons/svg/x-snap-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.horizontalSnapButton.setIcon(icon22)
...
#endif // QT_CONFIG(tooltip)
        icon23 = QIcon()
        icon23.addFile(u":/icons/svg/extract.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon23.addFile(u":/icons/svg/extract-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.selectViewButton.setIcon(icon23)
...
#endif // QT_CONFIG(tooltip)
        icon24 = QIcon()
        icon24.addFile(u":/icons/svg/y-snap.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon24.addFile(u":/icons/svg/y-snap-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.verticalSnapButton.setIcon(icon24)
        ...
        self.calibratedCheckBox.setGeometry(QRect(390, 10, 200, 40))
...
"")
        icon25 = QIcon()
        icon25.addFile(u":/icons/svg/toggle-off.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon25.addFile(u":/icons/svg/toggle-on.svg", QSize(), QIcon.Normal, QIcon.On)
        self.calibratedCheckBox.setIcon(icon25)
