...
"}")
        icon13 = QIcon()
        icon13.addFile(u":/icons/svg/play.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
#endif // QT_CONFIG(tooltip)
        icon15 = QIcon()
        icon15.addFile(u":/icons/svg/zoom.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon15.addFile(u":/icons/svg/zoom-on.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
#endif // QT_CONFIG(tooltip)
        icon16 = QIcon()
        icon16.addFile(u":/icons/svg/y-snap.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon16.addFile(u":/icons/svg/y-snap-on.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
#endif // QT_CONFIG(tooltip)
        icon17 = QIcon()
        icon17.addFile(u":/icons/svg/reset.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
#endif // QT_CONFIG(tooltip)
        icon19 = QIcon()
        icon19.addFile(u":/icons/svg/move.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon19.addFile(u":/icons/svg/move-on.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
"}")
        icon22 = QIcon()
        icon22.addFile(u":/icons/svg/plus-fig.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        icon23 = QIcon()
        icon23.addFile(u":/icons/svg/trash-fig.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
