...
"")
        ...
        sizePolicy5.setHeightForWidth(self.specVisibButton.sizePolicy().hasHeightForWidth())
        self.specVisibButton.setSizePolicy(sizePolicy5)
