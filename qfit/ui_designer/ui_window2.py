...
# Form implementation generated from reading ui_designer file '.\window2.ui_designer',
# licensing of '.\window2.ui_designer' applies.
#
...
from qfit.widgets.data_extracting import ListView, TableView
from qfit.widgets.data_tagging import IntTupleLineEdit, StrTupleLineEdit
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap(":/icons/20x20/cil-menu.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.frameCenter.setStyleSheet(
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-caret-right.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        icon4.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-caret-bottom.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.On,
        )
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-at.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-plus.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-minus.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        self.mplFigureCanvas = MplFigureCanvas(self.frameCenter)
        sizePolicy = QtWidgets.QSizePolicy(
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-reload.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-move.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-zoom-in.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(
            QtGui.QPixmap(":/icons/16x16/cil-location-pin.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        QtCore.QObject.connect(
            self.buttonMinimize, QtCore.SIGNAL("clicked()"), MainWindow.showMinimized
        )
        QtCore.QObject.connect(
            self.buttonClose, QtCore.SIGNAL("clicked()"), MainWindow.close
        )
        QtCore.QObject.connect(
            self.buttonMaximize, QtCore.SIGNAL("clicked()"), MainWindow.showMaximized
        )
        QtCore.QObject.connect(
            self.calibrateGroupPushButton,
            QtCore.SIGNAL("toggled(bool)"),
            self.calibrationQFrame.setVisible,
        )
        QtCore.QObject.connect(
            self.dataGroupPushButton,
            QtCore.SIGNAL("toggled(bool)"),
            self.xyzDataGridFrame.setVisible,
        )
        QtCore.QObject.connect(
            self.coloringPushButton,
            QtCore.SIGNAL("toggled(bool)"),
            self.colorGridGroupBox.setVisible,
        )
        QtCore.QObject.connect(
            self.bgndSubtractPushButton,
            QtCore.SIGNAL("toggled(bool)"),
            self.bgndSubtractQFrame.setVisible,
        )
        QtCore.QObject.connect(
            self.filtersPushButton,
            QtCore.SIGNAL("toggled(bool)"),
            self.filterQFrame.setVisible,
        )
    ...
    def retranslateUi(self, MainWindow):
        self.label.setText(
            QtWidgets.QApplication.translate("MainWindow", "qfit", None, -1)
        )
        self.label_4.setText(
            QtWidgets.QApplication.translate("MainWindow", "EXTRACT", None, -1)
        )
        self.coloringPushButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "COLORING", None, -1)
        )
        self.label_2.setText(
            QtWidgets.QApplication.translate("MainWindow", "MIN", None, -1)
        )
        self.label_3.setText(
            QtWidgets.QApplication.translate("MainWindow", "MAX", None, -1)
        )
        self.colorComboBox.setCurrentText(
            QtWidgets.QApplication.translate("MainWindow", "PuOr", None, -1)
        )
        self.bgndSubtractPushButton.setText(
            QtWidgets.QApplication.translate(
                "MainWindow", "BACKGROUND SUBTRACT", None, -1
            )
        )
        self.filtersPushButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "FILTERS", None, -1)
        )
        self.dataGroupPushButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "DATA", None, -1)
        )
        self.calibrateGroupPushButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "CALIBRATE", None, -1)
        )
        self.label_5.setText(
            QtWidgets.QApplication.translate("MainWindow", "TAG", None, -1)
        )
        self.tagDispersiveBareRadioButton.setStatusTip(
            QtWidgets.QApplication.translate("MainWindow", "RR", None, -1)
        )
        ...
        self.swapXYButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "X↔Y", None, -1)
        )
        self.modePlotButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "   PRE-FIT", None, -1)
        )
        self.modeFitButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "   FIT", None, -1)
        )
        self.modeTagButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "   TAG DATA", None, -1)
        )
        self.modeSelectButton.setText(
            QtWidgets.QApplication.translate("MainWindow", "   EXTRACT DATA", None, -1)
        )
