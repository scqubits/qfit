...
class UI_MainWindow:
    ...
    def setupUI_TabOrder(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.ui_tagData.tagCrossingDressedRadioButton, self.ui_tagData.initialStateSpinBox)
        MainWindow.setTabOrder(self.ui_tagData.initialStateSpinBox, self.ui_tagData.finalStateSpinBox)
