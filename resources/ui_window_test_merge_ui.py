...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/svg/cil-chart-line.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.modePrefitButton.setIcon(icon1)
...
"}")
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icons/svg/cil-speedometer.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.gridLayout_2.addItem(self.verticalSpacer_3, 7, 1, 1, 1)
