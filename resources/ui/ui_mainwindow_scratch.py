...
# Form implementation generated from reading ui_designer file 'ui_mainwindow.ui_designer',
# licensing of 'ui_mainwindow.ui_designer' applies.
#
...
=======
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.quickWidget_3.sizePolicy().hasHeightForWidth())
>>>>>>> master
...
=======
        ...
        MainWindow.setTabOrder(self.tagCrossingDressedRadioButton, self.inititalStateSpinBox)
>>>>>>> master
